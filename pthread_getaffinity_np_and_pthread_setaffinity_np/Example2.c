...
/* pthreadMessage1() function */

void *pthreadMessage1( void *ptr )
 {
    sleep(20);                 /* for sleep of 20 ms */
...
/* pthreadMessage2() function */

void *pthreadMessage2( void *ptr )
 {
    sleep(30);                 /* for sleep of 30 ms */
    char *msg;               /* for message */
    msg = (char *) ptr;      /* for assigns message passed by thread in main to msg */
    printf("\n%s \n", msg);    /* prints message passed by thread in main function */
    cpu_set_t      l_cpuSet;   /* for pthread_getaffinity_np() */
...
/* pthreadMessage3() function */

void *pthreadMessage3( void *ptr )
 {
    sleep(40);                 /* for sleep of 40 ms */
    char *msg;                 /* for message */
    msg = (char *) ptr;        /* for assigns message passed by thread in main to msg */
    printf("\n%s \n", msg);    /* prints message passed by thread in main function */
    cpu_set_t      l_cpuSet;   /* for pthread_getaffinity_np() */
...
/* pthreadMessage4() function */

void *pthreadMessage4( void *ptr )
 {
...
int main()
 {
    ...
    /* creating thread 1 */
    thread1Create = pthread_create(&thread1, NULL, &pthreadMessage1, (void*)thread1Msg);
    sleep(1);

    /* creating thread 2 */
    thread2Create = pthread_create(&thread2, NULL, &pthreadMessage2, (void*)thread2Msg);
    sleep(1);

    /* creating thread 3 */
    thread3Create = pthread_create(&thread3, NULL, &pthreadMessage3, (void*)thread3Msg);
    sleep(1);

    /* creating thread 4 */
    thread4Create = pthread_create(&thread4, NULL, &pthreadMessage4, (void*)thread4Msg);
